...
==========================================================================
                          RELEASE NOTES FOR
                VMware InstallBuilder Multiplatform
==========================================================================

  This Release Notes document is for VMware InstallBuilder Multiplatform. This
  Document contains late-breaking information about the product. Please 
  refer to the user guide for more information.

  * World-wide web                http://installbuilder.com/

  * Sales                         installbuilder-sales@vmware.com

  Should you have any question about VMware InstallBuilder, please don't
...
==========================================================================
  ...
  VMware InstallBuilder allows you to create easy to use Linux, macOS and Windows
  ...
  * Sell your software: A complicated, error-prone installation process
  can hurt your sales. VMware InstallBuilder installers "just work" providing a great
  end-user experience that helps sell your programs. 

  * Reduce development time: VMware InstallBuilder simplifies the
  process of creating installation packages so you can spend time
  developing your product and not building installers.

  * Lower support costs: VMware InstallBuilder installers simplify and automate many
  aspects of the installation process, reducing support costs and
  end-user frustration

  Check our web page: http://installbuilder.com or subscribe to our
...
==========================================================================
  ...
  Please consult the VMware InstallBuilder user and reference guides for
...
==========================================================================
  ...
  Upon purchase and registration of a VMware InstallBuilder software
  license you are entitled to maintenance and support services.
  VMware InstallBuilder Technical Support is available by e-mail and from our website.

  For technical support for VMware InstallerBuilder, go to:
  http://installbuilder.com/support.html
...
Version 20.12.0 (2020-12-28)
* Added macOS ARM support
* Added initial support for Linux ARM
* Improved DLL loading on Windows 7
...
Version 20.3.0 (2020-04-02)
* Prevent installers from using cmd.exe from the installer directory when executing bat scripts on Windows
...
* Fixed crash searching node in Builder tree in some scenarios

Version 20.2.0 (2020-02-19)
...
* Fixed InstallLocation registry value being improperly quoted

Version 18.11.0 (2018-11-30)
...
Version 17.11.1 (2017-12-04)
* Fixed crash opening project on macOS

Version 17.11.0 (2017-12-01)
...
Version 17.4.0 (2017-04-27)
* Added more translations for non-English languages

Version 17.2.0 (2017-02-23)
...
Version 16.11.1 (2016-12-04)
* Fixed new DMG building tools not properly bundled

Version 16.9.0 (2016-09-26)
...
==========================================================================
  ...
  VMware InstallBuilder uses a number of third party components, which
