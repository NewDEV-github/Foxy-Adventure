...
#onready var rtl = $Panel/Label
#
#func g_tree_entered():
#	set_visible(Globals.debugMode)
##	set_process(true)
...
#
#	add_header("Engine")
#	add_line("Game FPS", str(Engine.get_frames_per_second()))
#	add_line("Forced FPS", str(Engine.target_fps))
...
#
#	add_header("Game properties")
#	add_line('Selected character',str(Globals.selected_character))
#	add_line('Character path', str(Globals.character_path))
#	add_line('Game world', str(Globals.world))
#	add_line('Debug mode', str(Globals.debugMode))
#	set_process(false)
#func take_log():
#	pass
#
